...
# Expose the sps-coturn service as a domain name
echo "Expose the sps-coturn service as a domain name"
...
# Update the sps-coturn deployment to enable secure turn
...
#  Output the secure turn URI to the user
echo ""
echo ""
echo ""
